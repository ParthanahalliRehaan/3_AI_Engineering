...
const response = await openAI.responses.create({
    ...
    /*The reason(Why the above wont work) you’re only seeing `{}` is because you’re mixing two different APIs:
    ...
    // 🔧 Added parameters from AI Engineering notes
    temperature: 0.3,        // controls randomness (lower = more factual)
    top_p: 0.9,              // nucleus sampling
    top_k: 50,               // restricts to top 50 tokens
    max_output_tokens: 200   // ensures concise but complete output
});
